...
The next figure shows how individual sites in each protein change. Only diGly proteins present in MitoCarta are included. Glycolysation sites are simply indexed 1, 2, 3,... from the smallest to the largest position in the protein. White fill indicates non-significant change (FDR > 0.05).
